...
const secretPhrases = ["never" , "you" , "that" , "hello" , "good" , "how" , "innocent" , "pawn" , "humanity" , "politician" , "whom" , "language"];
let randomItem = "";
let clicked = [];
let result = "";
let mistakes=0;
...
function setUnderScores(){
    ...
    let mappeWord=splitedWord.map(letter=>(clicked.indexOf(letter)>=0 ? letter:"_"));
    result = mappeWord.join("");
